...
CHZZK_REDIRECT_URL = os.getenv("CHZZK_REDIRECT_URL", REDIRECT_URL)
...
# --- 채팅 세션 워치독 (끊긴 채팅 세션 자동 감지/재생성) ---
SESSION_WATCHDOG_INTERVAL_SECONDS = int(os.getenv("SESSION_WATCHDOG_INTERVAL_SECONDS", "3600"))
